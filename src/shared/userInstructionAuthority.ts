...
const DESIGN_MUTATION_AFTER_PATTERN = /^(?:创建|形成|修改|修订|更新|调整|整理|收束|重写|改写|提炼|生成|保存|建立|定义)/;
const CONCEPT_MUTATION_AFTER_PATTERN = /^(?:创建|形成|修改|修订|更新|调整|拆分|拆成|分成|合并|整合|生成|产出|发展|重写|改写|收束|扩展)/;
